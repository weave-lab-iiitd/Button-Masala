...
def main():
    ...
    while True:
        ...
        for decoded in zbar_image:
            ...
            try:
                cv2.line(blank_image,(1500-500-200-ll[0][0],ll[0][1]),(1500-500-200-ll[1][0],ll[1][1]),(255,255,255),10)
                cv2.line(blank_image,(1500-500-200-ll[1][0],ll[1][1]),(1500-500-200-ll[2][0],ll[2][1]),(255,255,255),10)
                cv2.line(blank_image,(1500-500-200-ll[2][0],ll[2][1]),(1500-500-200-ll[3][0],ll[3][1]),(255,255,255),10)
                cv2.line(blank_image,(1500-500-200-ll[3][0],ll[3][1]),(1500-500-200-ll[0][0],ll[0][1]),(255,255,255),10)
                cv2.line(blank_image,(1500-500-200-ll[0][0],ll[0][1]),(1500-500-200-ll[2][0],ll[2][1]),(255,255,255),10)
                cv2.line(blank_image,(1500-500-200-ll[2][0],ll[2][1]),(1500-500-200-ll[2][0],ll[2][1]),(0,0,255),25)
            except:
                continue
            ...
            try:
                ...
                for j in range(2,len(hist[decoded.data])):
                    ...
                    cv2.line(blank_image, (1500 - 500-200 - lx,ly),(1500  - 500-200 - hist[decoded.data][j][0], hist[decoded.data][j][1]), (100, (30+hist[decoded.data][j][1]+hist[decoded.data][j][0] )%254, 255), 10)
                    lx=hist[decoded.data][j][0]
                    ly=hist[decoded.data][j][1]
                    #print 'lo', lx, ly
            except:
